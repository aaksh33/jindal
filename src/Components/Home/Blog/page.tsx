        ...
        <>
            <section className="bg-light overflow-hidden py-14 lg:py-18 xl:py-22 bg-prim-light">
                <div className="container mx-auto max-w-7xl px-4 space-y-14">
                    ...
                    <div className="blog-wrappre grid lg:grid-cols-2 gap-5">
                        {blog.slice(0, 1).map((item) => (
                            <div key={item.id} className="blog-item w-full shadow-lg bg-white p-5 rounded-2xl group h-auto md:h-[640px]">
                                ...
                                <div className="blog-content px-2 py-5 space-y-5">
                                    ...
                                    <Link href={`/blog/${item.slug}`} className="text-sm lg:text-16 w-fit rounded-full font-chakrapetch font-semibold flex gap-2 px-2 justify-center items-center tracking-wider group mt-5 lg:mt-0 ">Read More 
                        ...
                        <div className="grid grid-cols-1 h-auto md:h-[620px] gap-5 ">
                            {blog.slice(1,3).map((item) => (
                                <div key={item.id} className="blog-item h-auto md:h-[310px] w-full flex flex-wrap md:flex-nowrap shadow-lg bg-white p-5 rounded-2xl group">
                                    <div className="blog-image w-full md:w-1/2 rounded-2xl overflow-hidden relative">
                                        <Image src={item.image} alt={item.title} width={250} height={250} className="w-full h-full group-hover:scale-110 transition duration-500 object-cover" />
